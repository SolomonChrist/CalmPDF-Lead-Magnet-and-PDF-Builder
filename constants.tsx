...
export const DEFAULT_ACCENT_COLOR = '#4F46E5'; // Indigo-600
...
export const DEFAULT_MARKETING_CONFIG = {
  ...
  subheadingText: 'Substack for greatness. Get the latest updates, tips, and exclusive resources delivered straight to your inbox.',
  ctaText: 'Visit solomonchrist.com',
  fontScale: 1.0,
};
